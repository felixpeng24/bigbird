...
In an era of increasing algorithmic governance, people are routinely scored, ranked, and categorized by automated systems they cannot see, understand, or contest. Across hiring platforms, predictive policing tools, credit scoring, and social media content curation, opaque algorithms classify individuals by demographic proxies—race, gender, age, socioeconomic status—and produce outputs that carry the weight of objectivity without the substance of it. A 2023 UNESCO report found that AI-driven hiring tools discriminated against women and minorities in over 60% of audited cases, and ProPublica's analysis of the COMPAS recidivism algorithm revealed that Black defendants were nearly twice as likely to be falsely flagged as high-risk compared to white defendants. The people being scored rarely know the criteria, cannot challenge the results, and are left to absorb consequences shaped by bias encoded as math.

The core barrier is invisibility. These systems operate behind interfaces that feel neutral and authoritative. Most people lack the technical literacy to interrogate an algorithm's assumptions, and most algorithms are proprietary enough to resist scrutiny even from those who do. The result is a population that accepts machine-generated judgments as objective truths—not because the systems have earned that trust, but because their complexity discourages questioning. As Dunne and Raby argue, passive consumption of these systems prevents the kind of active critical engagement that meaningful democratic participation requires.

Conceptual art offers a vehicle for this disruption. By creating what Taryn Simon calls a "seductive frame," audiences can approach subjects they might otherwise avoid. However, passive observation alone is insufficient to challenge internalized assumptions about algorithmic authority. This problem demands interactive, participatory artistic interventions that engineer direct confrontation—works that, as Flanagan argues, use play and humor to lower defenses and catalyze genuine self-interrogation. The goal is a physical art piece, designed and built within the semester timeframe and a $333 individual budget, that builds upon the themes of Simon's Kleroterion to make the arbitrariness of algorithmic classification visceral and personal. Success looks like participants walking away unable to take the next algorithmic score they encounter at face value.
